...
_dir_parent = Path(__file__).parent.parent.parent  ## vqt outer directory
...
## Get version number
with open(str(_dir_parent / "vqt" / "__init__.py"), "r") as _f:
    for _line in _f:
